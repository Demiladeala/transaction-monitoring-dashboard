      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="relative w-full lg:max-w-md">
          ...
          <input
            ...
            className="h-11 w-full rounded-xl border border-stroke2 bg-white pl-9 pr-4 text-sm text-slate-900 outline-none transition-colors placeholder:text-slate-400 focus:border-primary"
          />
        </div>

        <div className="flex flex-wrap gap-3">
          <div className="flex h-11 items-center gap-2 rounded-xl border border-stroke2 bg-white px-3 text-sm text-slate-500">
          ...
          {isPolling && (
            <div className="flex h-11 items-center gap-2 rounded-xl border border-stroke2 bg-white px-3 text-sm text-slate-600">
